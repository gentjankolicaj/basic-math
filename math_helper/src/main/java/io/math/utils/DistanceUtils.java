...
public class DistanceUtils {
	...
	public static double distance(double x1, double x2, double y1, double y2, double z1, double z2, double w1,
			double w2) {
		double x = x2 - x1;
		double y = y2 - y1;
		double z = z2 - z1;
	...
	public static double distance(Point point1, Point point2) {
		...
		Dimension contextDimension = dimIndex1 >= dimIndex2 ? point1.getDimension() : point2.getDimension();

		if (contextDimension.equals(Dimension.D4)) {
			return distance(point1.getX(), point2.getX(), point1.getY(), point2.getY(), point1.getZ(), point2.getZ(),
